...
public class AdapterHosts extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//        }
    ...
    public class VideoViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            binding.lytstatus.setVisibility(girl.isBusy() ? View.VISIBLE : View.GONE);
            ...
            if (girl.isFake()) {
                binding.imgThumb.setOnClickListener(v -> onHostThumbClickListner.onClick(girl));

            } else {
                binding.imgThumb.setOnClickListener(v -> {
                    if (sessionManager.getUser().getCoin() <= sessionManager.getSetting().getCallChargeforUser()) {
                        ...
                        onHostThumbClickListner.onClick(girl);
